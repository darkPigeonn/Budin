...
public class sistem_saraf_tepi1 extends AppCompatActivity {
    float x1,x2,y1,y2;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_sistem_saraf_tepi1);
    ...
    public boolean onTouchEvent(MotionEvent touchEvent) {
        ...
        switch(touchEvent.getAction()){
            ...
            case MotionEvent.ACTION_UP:
                ...
                y2 = touchEvent.getY();
                if(x1 < x2){
                    Intent i = new Intent(sistem_saraf_tepi1.this, sistem_saraf_tepi2.class);
                    startActivity(i);
                    finish();

                }
                else if(x1 > x2){
                    Intent i = new Intent(sistem_saraf_tepi1.this, sistem_saraf_tepi.class);
                    startActivity(i);
                    finish();
                }
                break;
