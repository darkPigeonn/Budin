...
public class gangguan_telinga extends AppCompatActivity {
    float x1,x2,y1,y2;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_gangguan_telinga);

        Button back = findViewById(R.id.back_button);
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(gangguan_telinga.this, sistem_indra_menu.class));
                finish();
            }
        });
        ...
        home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(gangguan_telinga.this, home_screen.class));
                finish();
            }
        });
    }
    ...
    public boolean onTouchEvent(MotionEvent touchEvent) {
        ...
        switch(touchEvent.getAction()){
            ...
            case MotionEvent.ACTION_UP:
                ...
                y2 = touchEvent.getY();
                if(x1 > x2){
                    Intent i = new Intent(gangguan_telinga.this, fungsi_telinga.class);
                    startActivity(i);
                    finish();
