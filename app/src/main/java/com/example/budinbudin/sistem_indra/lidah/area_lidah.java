...
public class area_lidah extends AppCompatActivity {
    float x1,x2,y1,y2;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_area_lidah);

        Button back = findViewById(R.id.back_button);
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(area_lidah.this, sistem_indra_menu.class));
                finish();
            }
        });
        ...
        home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(area_lidah.this, home_screen.class));
                finish();
            }
        });
    }
    ...
    public boolean onTouchEvent(MotionEvent touchEvent) {
        ...
        switch(touchEvent.getAction()){
            ...
            case MotionEvent.ACTION_UP:
                ...
                y2 = touchEvent.getY();
                if(x1 < x2){
                    Intent i = new Intent(area_lidah.this, fungsi_lidah.class);
                    startActivity(i);
                    finish();
